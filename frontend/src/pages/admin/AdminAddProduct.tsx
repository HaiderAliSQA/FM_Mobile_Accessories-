  ...
  return (
    <div className="max-w-5xl mx-auto pb-12 font-dm">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="font-playfair text-fm-text text-3xl font-semibold tracking-wide">Add New Product</h1>
          <p className="text-fm-text-2 mt-2 text-sm tracking-wider">Expand your FM Mobile collection</p>
        </div>
        <button
          type="button"
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="bg-white border border-fm-border p-8 shadow-sm">
            ...
            {images.map((img, i) => (
              <div key={i} className="relative aspect-square rounded-sm border border-fm-border group overflow-hidden bg-fm-bg">
                ...
                <button
                  ...
                  className="absolute top-1 right-1 bg-fm-error text-white rounded p-1.5 opacity-0 group-hover:opacity-100 transition-opacity"
                  title="Remove image"
                >
          ...
          {images.length === 0 && <p className="text-fm-error text-xs font-dm mt-2">At least one image is required.</p>}
        </div>
        ...
        <div className="flex justify-end gap-4 pt-4">
          ...
          <button
            ...
            className="w-48 bg-fm-gold text-white font-dm text-[13px] tracking-widest uppercase font-medium hover:bg-fm-gold-light transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm h-12"
          >
