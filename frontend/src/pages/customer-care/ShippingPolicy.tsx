...
const ShippingPolicy: React.FC = () => {
  return (
    <div className="pt-24 pb-20 px-6 sm:px-6 lg:px-8 max-w-4xl mx-auto bg-fm-bg">
      <h1 className="font-playfair text-4xl text-fm-text mb-4 text-center">Shipping Policy</h1>
      ...
      <div className="bg-white border border-fm-border p-8 lg:p-10 space-y-10">
        ...
        <section>
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="font-playfair text-2xl text-fm-text">Delivery Timelines</h2>
          </div>
          <p className="font-dm text-fm-text-2 leading-relaxed ml-9">
        ...
        <section>
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="font-playfair text-2xl text-fm-text">Shipping Charges</h2>
          </div>
          <p className="font-dm text-fm-text-2 leading-relaxed ml-9 mb-4">
          ...
          <div className="ml-9 p-4 bg-[#f8f5f0] border-l-2 border-fm-gold font-dm text-fm-text text-sm italic">
        ...
        <section>
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="font-playfair text-2xl text-fm-text">Areas Covered & Couriers</h2>
          </div>
          <p className="font-dm text-fm-text-2 leading-relaxed ml-9">
        ...
        <section>
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="font-playfair text-2xl text-fm-text">Cash on Delivery (COD)</h2>
          </div>
          <p className="font-dm text-fm-text-2 leading-relaxed ml-9 mb-3">
            Cash on Delivery is fully supported for all our accessory collections. 
          </p>
          <ul className="ml-9 list-disc pl-5 font-dm text-fm-text-2 space-y-2">
